...
namespace core\application\routing
{
	...
	abstract class RoutingHandler
	{
		...
		/**
		 * Méthode permettant de remplacer les caractères spéciaux
		 * @param $text
		 * @return mixed|string
		 */
		static public function despecialize($text)
		{
			static $in  = array('þ','ß','é','è','ë','ê','à','á','ä','â','ã','å','ò','ó','ö','ô','õ','ø','ì','í','ï','î','ð','ñ','û','ü','ù','ú','ç','ÿ','ý','ý','œ','æ','À','Á','Â','Ã','Ä','Å','Ç','È','É','Ê','Ë','Ì','Í','Î','Ï','Ð','Ñ','Ò','Ó','Ô','Õ','Ö','Ø','Ù','Ú','Û','Ü','Ý','Ÿ');
			static $out = array('b','s','e','e','e','e','a','a','a','a','a','a','o','o','o','o','o','o','i','i','i','i','d','n','u','u','u','u','c','y','y','y','oe','ae','A','A','A','A','A','A','C','E','E','E','E','I','I','I','I','D','N','O','O','O','O','O','O','U','U','U','U','Y','Y');
