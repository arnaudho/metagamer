...
{if $content.cards}
    ...
    <ul class="nav nav-tabs analysis-tabs">
        <li class="active"><a data-toggle="tab" href="#maindeck">Maindeck</a></li>
        <li><a data-toggle="tab" href="#sideboard">Sideboard</a></li>
    </ul>

    <div class="tab-content">
        <div id="maindeck" class="tab-pane fade in active">
        ...
        <div id="sideboard" class="tab-pane fade">
            <table class="table table-hover table-condensed archetype-analysis" data-toggle="table" data-sort-name="winrate_with" data-sort-order="desc">
                <thead>
                    <tr>
                        <th>Actions</th>
